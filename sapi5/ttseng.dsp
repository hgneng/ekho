...
# ADD CPP /nologo /MT /W3 /O1 /I "..\..\..\..\..\ddk\include" /I "..\..\..\..\include" /I "C:\Program Files\Microsoft Speech SDK 5.1\Include" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "_ATL_STATIC_REGISTRY" /Yu"stdafx.h" /FD /c
# ADD MTL /I "..\..\..\..\..\ddk\idl" /I "..\..\..\..\idl"
# SUBTRACT MTL /Oicf
...
# ADD LINK32 kernel32.lib advapi32.lib ole32.lib /nologo /subsystem:windows /dll /map /machine:I386 /libpath:"..\..\..\..\lib\i386" /libpath:"C:\Program Files\Microsoft Speech SDK 5.1\Lib\i386"
# Begin Custom Build - Performing registration
OutDir=.\Release_x86
TargetPath=.\Release_x86\ttseng.dll
InputPath=.\Release_x86\ttseng.dll
SOURCE="$(InputPath)"
